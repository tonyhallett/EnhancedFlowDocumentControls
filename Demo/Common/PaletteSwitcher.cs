...
namespace Demo.Common
{
    internal sealed class PaletteSwitcher : INotifyPropertyChanged
    {
        private readonly Palette _bluePalette = new Palette
        {
            ...
            GlyphBrush = Brushes.DarkBlue,
            StateBackground = Brushes.DarkBlue,
            StateBorderBrush = Brushes.LightBlue,
            StateGlyphBrush = Brushes.LightBlue,
        ...
        private readonly Palette _pinkPalette = new Palette
        {
            ...
            GlyphBrush = Brushes.DeepPink,
            StateBackground = Brushes.DeepPink,
            StateBorderBrush = Brushes.Pink,
            StateGlyphBrush = Brushes.Pink,
